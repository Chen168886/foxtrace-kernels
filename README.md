...
| Firefox | 155.0（含启动授权保护） | [Firefox-155.0-win64-20260915.zip](../../releases/download/firefox-155.0/Firefox-155.0-win64-20260915.zip) | 128 MB | `29F1AAD95BB6F20C` |
...
- **必须配合最新版 FoxTrace 管理器使用。** Firefox 内核内建启动授权保护，与旧版管理器不兼容；两者必须为同期版本，请先升级管理器再更换内核。
